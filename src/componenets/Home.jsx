...
import { FaInstagramSquare, FaTelegram, FaLinkedin, FaReact, FaJs } from "react-icons/fa";
      ...
      <div name='Home' className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-20">
        <div className='flex flex-col md:flex-row'>
                ...
                <ul className='flex space-x-5'>
                  <li>
                    <a href="https://www.instagram.com/muhammad.kaif86" target='_blank' rel='noreferrer'>
                      <FaInstagramSquare className='text-2xl cursor-pointer hover:text-pink-600 duration-200' />
                    </a>
                  </li>
                  <li>
          ...
          <div className='w-full md:w-1/2 md:ml-48 md:mt-20 mt-8 order-1 flex justify-center'>
            <img 
              src={Photo} 
              className='rounded-full w-[280px] h-[280px] md:w-[450px] md:h-[450px] object-cover border-4 border-gray-200 shadow-xl' 
              alt="Idrisi Kaif Profile" 
            />
          </div>
        </div>
      </div>
